...
# DozenOS CLI. Telegraf ships ~240 inputs and ~60 outputs, which produces a 198 MB
# binary; the list below brings that down to about 28 MB.
#
# These names are the plugins referenced by the dozenos-1x telegraf templates in
