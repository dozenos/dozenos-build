...
DEBIAN_DIR="${CWD}/dozenos-intel-${DRIVER_NAME}_${DRIVER_VERSION}_${DEBIAN_ARCH}"
DEBIAN_CONTROL="${DEBIAN_DIR}/DEBIAN/control"
DEBIAN_POSTINST="${CWD}/dozenos-intel-${DRIVER_NAME}.postinst"

# See https://dozenos.dev/T6155
# See https://dozenos.dev/T6162
...
echo "I: Building Debian package dozenos-intel-${DRIVER_NAME}"
cd ${CWD}
...
fpm --input-type dir --output-type deb --name dozenos-intel-${DRIVER_NAME} \
