...
DEBIAN_POSTINST="${CWD}/dozenos-ipt-netflow.postinst"
...
echo "I: Building Debian package dozenos-ipt-netflow"
...
fpm --input-type dir --output-type deb --name dozenos-ipt-netflow \
