...
DozenOS runs on a custom Linux Kernel (which is 6.6) at the time of this writing.
...
DozenOS does not utilize the build in Intel Kernel drivers for its NICs as those
...
DozenOS requires two additional patches to work which are stored in the patches/kernel
folder.

### Config

The Kernel configuration used is [x86_64_dozenos_defconfig](x86_64_dozenos_defconfig)
...
DozenOS utilizes several Out-of-Tree modules (e.g. WireGuard, Accel-PPP and Intel
