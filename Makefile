...
# flavor rule below and run build-dozenos-image with garbage arguments.
...
.PHONY: purge
purge:
	rm -rf build packer_build packer_cache testinstall-*.raw ci_data ci_seed.iso nested_iso_data nested_installer_payload.iso dozenos-*.tar.xz
